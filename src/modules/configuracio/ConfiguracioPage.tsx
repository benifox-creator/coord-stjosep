  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-gray-400 leading-relaxed">
        Els nous usuaris entren per defecte com a <strong className="text-gray-600">Convidat</strong> (sols lectura).
        Assigna el perfil adequat a cada persona des d'aquí.
      </p>
